...
Wrap the button in a container that uses the [font-size utility classes]({{ site.baseurl }}{% link docs/just-the-docs_documentation/utilities/typography.md %}) to scale buttons:
