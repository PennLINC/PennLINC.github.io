...
```
---
**NOTE:**   For XCP, you will need to supply arguments in the form of all the .csvs you want to concatenate, removing subject and session, in the following format:
``shell
